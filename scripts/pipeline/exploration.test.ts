...
function equalScoreCatalog(): CatalogRecord {
  ...
  catalog.games.forEach((game, index) => {
    ...
    game.buzz = { twitchViewers: 1_000, twitchChannels: 10, viewerGrowth7d: 1, isNewRelease: true, demandShare: 0, demandSources: { chzzk: false, twitch: true }, sourceStatus: { chzzk: "fresh", twitch: "fresh" } };
