...
function legacyCatalog() {
  return {
    ...
    games: [{
      ...
      viewerPlayable: { ok: false },
      vibes: { healing: 0.5, variety: 0.5, horror: 0.5, hardcore: 0.5, chatting: 0.5, spectacle: 0.5 },
      buzz: { twitchViewers: 12, twitchChannels: 3, viewerGrowth7d: -0.25, isNewRelease: true, demandShare: 0, demandSources: { chzzk: false, twitch: true }, sourceStatus: { chzzk: "fresh", twitch: "fresh" } },
      topTags: [],
      rating: 90,
      reviewCount: 100,
    }],
